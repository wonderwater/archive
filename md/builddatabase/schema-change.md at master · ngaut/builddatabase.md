> 本文由 [简悦 SimpRead](http://ksria.com/simpread/) 转码， 原文地址 [github.com](https://github.com/ngaut/builddatabase/blob/master/f1/schema-change.md)
...
基于前面的讨论，到 _reorg_ 完成时，我们的数据不少不多也不错乱，可以放心地改为 _public_ 状态了。
